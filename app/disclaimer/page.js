    ...
    return (
        <div className="bg-white text-gray-800 px-4 md:px-20 py-10 md:py-20">
            ...
            <div className="bg-blue-100 border-l-4 border-blue-500 text-blue-900 p-6 mb-10 rounded-md">
                <p className="mb-4">
                    <strong>Hewlett Hub Solutions</strong> is an independent informational website and is not affiliated with or endorsed by any printer manufacturers, including but not limited to HP (Hewlett-Packard), Epson, Canon, Brother, or Lexmark.
                </p>
                <p className="mb-4">
