  ...
  const services = [
    {
      ...
      fullDescription: 'Hewlett Hub Solutions provides cutting-edge AI automation that learns from your patterns to optimize business processes. Our solution reduces manual work by up to 80% while maintaining 99.9% accuracy. Perfect for data entry, customer service, and operational workflows.',
      icon: (
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            ...
            <span className="block text-indigo-600">Hewlett Hub Solutions</span>
          </h1>
        ...
        <div className="mt-20 bg-indigo-700 rounded-xl p-8 md:p-12 text-center">
          ...
          <p className="text-indigo-100 max-w-2xl mx-auto mb-8">
            Our team at Hewlett Hub Solutionsis ready to help you implement the perfect solution for your needs.
          </p>
